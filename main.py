...
if operation is not None:
    ...
    pass
st.markdown("Enjoying my app? Stay updated with more projects by following me on Twitter at [@4gameparth](https://twitter.com/4gameparth)!!", unsafe_allow_html=True)
